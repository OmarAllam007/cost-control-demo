...
{
    protected $fillable = [
        "project_id", "wbs_level_id", "period_id", "resource_id", "breakdown_resource_id", "current_cost", "current_qty",
        "current_unit_price", "previous_cost", "previous_qty", "to_date_cost", "to_date_qty", "previous_unit_price",
