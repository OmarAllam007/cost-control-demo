...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        \View::composer(['project.tabs._wbs','wbs-level._recursive_input','wbs-level._recursive','wbs-level._modal','csi-category.index'], 'App\Http\ViewComposers\WbsComposer');
