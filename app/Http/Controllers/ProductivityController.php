...
class ProductivityController extends Controller
{
    ...
    public function import()
    {
        ...
        if ($handle !== FALSE) {
            fgetcsv($handle);
            $productivity_category = CsiCategory::query()->pluck('name', 'id')->toArray();
...
//        if ($handle !== FALSE) {
//            fgetcsv($handle);
//            $productivity_category = CsiCategory::query()->pluck('id', 'name')->toArray();
...
//
//            }
//            $category = CsiCategory::where('name', 'LIKE', $inputs[1])->first();
//
//            $unit = Unit::where('type', $inputs[2])->first();
//
//            if (is_null($category)) {
//                $create_category = CsiCategory::create([
//                    'name' => $inputs[1],
//                    'parent_id' => $parent_id
//                ]);
//
