    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled masterdata-tree">
                ...
                @can('read', 'resources')
                <li>
                    <a href="#resources-menu" class="sub-menu-toggle" data-toggle="collapse"><i class="fa fa-caret-right"></i> <strong>Resources</strong></a>
                ...
                @can('read', 'productivity')
                    <li>
                        <a href="#productivity-menu" class="sub-menu-toggle"  data-toggle="collapse"><i class="fa fa-caret-right"></i> <strong>Productivity</strong></a>
                ...
                @if (Auth::user()->is_admin)
                    <li><a href="{{route('roles.index')}}"><i class="fa fa-caret-right"></i> Communication Plan</a></li>
                    <li><a href="{{route('users.index')}}"><i class="fa fa-caret-right"></i> Users</a></li>
                    <li><a href="{{route('global-periods.index')}}"><i class="fa fa-caret-right"></i> Periods</a></li>
                @endif
            </ul>
            </div>
        </div>
