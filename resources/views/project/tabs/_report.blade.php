<table class="table table-condensed table-striped table-fixed text-center">
    ...
    <tr>
        <th class="col-xs-4">
            ...
            <a href="#" class="btn btn-success" style="width:100%;margin-bottom: 2px;">BOQ PRICE LIST</a><br>
        </th>
        <th class="col-xs-4">
            ...
            <a href="#" class="btn btn-success" style="width:100%;margin-bottom: 2px;">Budget Summary</a><br>
            <a href="#" class="btn btn-success" style="width:100%;margin-bottom: 2px;">Activity Resource Breakdown</a><br>
            <a href="#" class="btn btn-success" style="width:100%;margin-bottom: 2px;">Revised BOQ
            </a><br>
        </th>
        <th class="col-xs-4">
            <a href="#" class="btn btn-success" style="width:100%; margin-bottom: 2px;">Budget Cost By Buildings</a><br>
            <a href="#" class="btn btn-success" style="width:100%;margin-bottom: 2px;">Budget Cost by Disicpline</a><br>
            <a href="#" class="btn btn-success" style="width:100%;margin-bottom: 2px;">Budget Cost by Item Break Dowm
            </a><br>
            <a href="#" class="btn btn-success" style="width:100%;margin-bottom: 2px;">Budget Cost v.s Dry Cost By Building
            </a><br>
            <a href="#" class="btn btn-success" style="width:100%;margin-bottom: 2px;">Budget Cost v.s Dry Cost By Disicpline
            </a><br>
            <a href="#" class="btn btn-success" style="width:100%;margin-bottom: 2px;">Budget Cost v.s Dry Cost QTY & Cost
            </a><br>
        </th>
    </tr>
    </thead>
