...
<table class="table table-condensed table-striped table-fixed text-center">
    ...
    <tr id="buttons">
        ...
        <th class="col-xs-4">
            <a href="{{route('resource_dictionary.report',$project)}}" target="_blank" class="btn btn-success threeD"
        ...
        <th class="col-xs-4">
            <a href="{{route('budget_cost_by_building.report',$project)}}" target="_blank" class="btn btn-success threeD"
               style="width:100%; margin-bottom: 2px;">Budget Cost By Building</a><br>
            <a href="{{route('budget_cost_by_discipline.report',$project)}}" target="_blank" class="btn btn-success threeD"
               style="width:100%;margin-bottom: 2px;">Budget Cost by Disicpline</a><br>
            <a href="{{route('budget_cost_vs_break_down.report',$project)}}" target="_blank" class="btn btn-success threeD"
               style="width:100%;margin-bottom: 2px;">Budget Cost by Item Break Dowm
            </a><br>
            <a href="{{route('budget_cost_dry_cost.report',$project)}}" target="_blank" class="btn btn-success threeD"
            ...
            <a href="{{route('budget_cost_dry_cost_discipline.report',$project)}}" target="_blank"
               class="btn btn-success threeD" style="width:100%;margin-bottom: 2px;">Budget Cost v.s Dry Cost By Disicpline
            </a><br>
            <a href="{{route('qty_cost_discipline.report',$project)}}" target="_blank" class="btn btn-success threeD"
