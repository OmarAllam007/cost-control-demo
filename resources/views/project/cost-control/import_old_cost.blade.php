...
@section('body')
    <div class="row">
        <div class="col-md-6 col-sm-9">
            ...
            <p class="text-info">
                <i class="fa fa-download"></i> Please <a href="{{asset('/files/templates/old-data-template.xlsx')}}">click here</a> to download a sample template
            </p>
