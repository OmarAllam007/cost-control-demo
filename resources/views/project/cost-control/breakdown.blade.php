            ...
            <div class="scrollpane">
                <table class="table table-condensed table-striped table-hover table-breakdown">
                    ...
                    <tr>
                        ...
                        <th class="bg-orange" style="min-width: 150px; max-width: 150px;">To Date Price / Unit ( Eqv.
                            )
                        </th>
                        ...
                        <th class="bg-orange" style="min-width: 150px; max-width: 150px;">Cost Variance To Date Due to
                            Unit
                            Price
                        </th>
                        ...
                        <th class="bg-orange" style="min-width: 150px; max-width: 150px;">Cost Variance Completion Due
                            to
                            Unit Price
                        </th>
                        <th class="bg-orange" style="min-width: 150px; max-width: 150px;">Cost Variance Completion Due
                            ...
                            <td style="min-width: 30px; max-width: 30px">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        @can('manual_edit', $project)
                                            <li><a :href="'/cost/' + breakdown.id + '/edit/'" class="in-iframe"
