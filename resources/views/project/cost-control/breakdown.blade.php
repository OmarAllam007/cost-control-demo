        ...
        <div class="scrollpane" v-if="filtered_breakdowns.length">
            ...
            <table class="table table-condensed table-striped table-hover table-breakdown">
                ...
                <tr v-for="breakdown in filtered_breakdowns">
                    ...
                    <td class="bg-green" style="min-width: 150px; max-width: 150px;">@{{ breakdown.previous_unit_price|number_format }}</td>
                    <td class="bg-green" style="min-width: 150px; max-width: 150px;">@{{ breakdown.previous_qty|number_format }}</td>
                    <td class="bg-green" style="min-width: 150px; max-width: 150px;">@{{ breakdown.previous_cost|number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.current_unit_price|number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.current_qty|number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.current_cost|number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.to_date_unit_price|number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.to_date_qty|number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.to_date_cost|number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.allowable_ev_cost | number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.allowable_var | number_format }}</td>
                    <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown.remaining_unit_price | number_format }}</td>
                    <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown.remaining_qty | number_format }}</td>
                    <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown.remaining_cost | number_format }}</td>
                    <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown.bl_allowable_cost | number_format }}</td>
                    <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown.bl_allowable_var | number_format }}</td>
                    <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown.completion_unit_price | number_format }}</td>
                    <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown.completion_qty | number_format }}</td>
                    <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown.completion_cost | number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.qty_var | number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.cost_var | number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.unit_price_var | number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.physical_unit | number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px;">@{{ breakdown.pw_index | number_format }}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px">@{{breakdown.cost_variance_to_date_due_unit_price | number_format}}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px">@{{breakdown.allowable_qty | number_format}}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px">@{{breakdown.cost_variance_remaining_due_unit_price | number_format}}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px">@{{breakdown.cost_variance_completion_due_unit_price | number_format}}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px">@{{breakdown.cost_variance_completion_due_qty | number_format}}</td>
                    <td class="bg-orange" style="min-width: 150px; max-width: 150px">@{{breakdown.cost_variance_to_date_due_qty | number_format}}</td>
                </tr>
                </tbody>
            </table>
        </div>
