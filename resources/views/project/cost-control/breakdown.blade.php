                ...
                <div class="scrollpane">
                    <table class="table table-condensed table-striped table-hover table-breakdown">
                        ...
                        <tr>
                            ...
                            <th class="bg-violet" style="min-width: 150px; max-width: 150px;">Completion Cost Var (+/-) - Optimistic</th>
                            <th class="bg-violet" style="min-width: 150px; max-width: 150px;">Completion Cost - Most Liekly</th>
                            <th class="bg-violet" style="min-width: 150px; max-width: 150px;">Completion Cost Var (+/-) - Most Liekly</th>
                            <th class="bg-violet" style="min-width: 150px; max-width: 150px;">Completion Cost - Pessimistic</th>
                            <th class="bg-violet" style="min-width: 150px; max-width: 150px;">Completion Cost Var (+/-) - Pessimistic</th>
                    ...
                    <table class="table table-condensed table-striped table-hover table-breakdown">
                        ...
                        <tr v-for="breakdown in breakdowns">
                            ...
                            <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown? breakdown.completion_var_optimistic : 0 | number_format }}</td>
                            <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown? breakdown.completion_cost_likely : 0 | number_format }}</td>
                            <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown? breakdown.completion_var_likely : 0 | number_format }}</td>
                            ...
                            <td class="bg-violet" style="min-width: 150px; max-width: 150px;">@{{ breakdown? breakdown.completion_var_pessimistic : 0 | number_format }}</td>
                            <td class="bg-orange"
