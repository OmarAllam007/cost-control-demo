                ...
                <div class="modal-body">
                    ...
                    <section>
                        <ul class="list-unstyled tree">
                            ...
                            @include('resources._recursive_resource_input', ['type' => $type, 'value' => Form::getValueAttribute('resource_name')])
                            @endforeach
                        </ul>
                    </section>
                </div>
...
{{--@else--}}
<resources
        :resource="{{($resource_id = Form::getValueAttribute('resource_name'))? json_encode(\App\Resources::find(Form::getValueAttribute('resource_name'))->morphToJSON()) : '{}' }}"></resources>
{{--@endif--}}