...
@section('header')
    <h2>{{$project->name}} &mdash; Import Labor-Trend Report</h2>
...
@section('body')
    <div class="row">
        <div class="col-md-6 col-sm-9">
            ...
            {{Form::open(['route' => ['cost-labor.import', $project], 'files' => true])}}
        ...
        <table class="table table-striped table-hover table-condensed">
            ...
            @foreach($data  as $item)
                ...
                <tr>
                    ...
                    <td><i class="fa fa-download"></i>  <a href="{{'/download_labor_trend/' . $item->id.'/download'}}"> {{$item->created_at}}</a></td>
                </tr>
        @endforeach
    </div>
@endsection