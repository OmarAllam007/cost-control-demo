                        ...
                        <table class="table table-condensed" style="border-bottom: 2px solid black;">
                            ...
                            @foreach(collect($type['resources'])->sortBy('name') as $keyResource=>$resource)
                                <tr style="border-bottom: 1px solid lightgray;">
                                    ...
                                    <td  style="background: #defdff">{{number_format($resource['budget_unit']??0,2) }}</td>
                                    ...
                                    <td  style="border-left:1px solid lightgray; border-right:1px solid  lightgray;">{{number_format($resource['to_date_qty']??0,2) }}</td>
                                    ...
                                    <td>{{number_format($resource['remaining_qty']??0,2) }}</td>
                                    ...
                                    <td>{{number_format($resource['completion_qty']??0,2) }}</td>
