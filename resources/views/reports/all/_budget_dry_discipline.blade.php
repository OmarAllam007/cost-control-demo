...
<table>
    ...
    <tr>
        ...
        <td class="col-xs-4">
            <a class="btn btn-success visible-button resource-dictionary" style="width:100%; margin-bottom: 2px;">RESOURCE
                DICITIONARY</a><br>
        ...
        <td class="col-xs-4">
            ...
            <a class="btn btn-success visible-button cost-dry-discipline" style="width:100%;margin-bottom: 2px;background-color: #3e5a20;">Budget Cost v.s
