                    ...
                    <td>
                        <div class="display-flex">
                            ...
                            @if ($budget_info['revision1']['budget_cost'] >= $budget_info['revision0']['budget_cost'])
                                <span class="text-success"><i class="fa fa-2xfa-arrow-circle-up"></i></span>
                            @else
                                <span class="text-danger"><i class="fa fa-2x fa-arrow-circle-down"></i></span>
                            @endif
                        </div>
                    </td>
                </tr>
                    ...
                    <td>
                        <div class="display-flex">
                            ...
                            @if ($budget_info['revision1']['direct_cost'] >= $budget_info['revision0']['direct_cost'])
                                <span class="text-success"><i class="fa fa-2xfa-arrow-up"></i></span>
                            @else
                                <span class="text-danger"><i class="fa fa-2x fa-arrow-circle-down"></i></span>
                            @endif
                        </div>
